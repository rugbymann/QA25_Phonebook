...
public class ContactHelper extends HelperBase{
    ...
    public boolean isContactAdded(String text){
        ...
        for (WebElement elements: contacts) {
            if (elements.getText().contains(text))
                return  true;
    ...
    public void addContact() {
        fillContactForm(new Contact().setName("Karl").setSurname("Baba").setPhone("112323123123").setEmail( "karl@mail.ru").setAddress("FFM").setDesc("forward"));
        clickOnSaveButton();
    }
}
